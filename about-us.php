			...
			<div class="row d-flex justify-content-center">
				<div class="col-lg-12">
					<div class="main_title">
						<p>Meet the people behind the curtains</p>
						<h1>Developer Team Members</h1>
						<span class="title-widget-bg"></span>
					</div>
				</div>
			</div>
			<div class="row team_center justify-content-center">
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid w-100" src="img/team/team-1.jpg" alt="Imtiaz">
							<div class="hover">
								<h4>Imtiaz Pranto</h4>
				...
				<div class="col-lg-3 col-md-6 justify-content-center"  >
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid w-100" width="300" height="300" src="img/team/team-4.jpg" alt="Shakira">
							<div class="hover">
								<h4>Shakira Mustary</h4>
								<p>Senior Designer</p>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5">
					...
					<a href="login.php" class="primary-btn">Book a Trip</a>
				</div>
