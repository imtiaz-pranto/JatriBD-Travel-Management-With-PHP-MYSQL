			...
			<div class="row d-flex justify-content-center">
				<div class="col-lg-12">
					<div class="main_title">
						<p>Learn about Bangladesh</p>
						<h1>Popular Places Around the Country</h1>
		...
		<div class="popular-places-slider owl-carousel">
			<div class="single-popular-places">
				<div class="popular-places-img">
					<img height="400"src="img/places/p1.jpg" alt="">
				</div>
				<div class="popular-places-text">
					<a href="single-blog.html">
					</a>
					<p>the Royal Bengal Tigers</p>
					<h4>
						Learn about The Exotic King of the Jungle.
					</h4>
				</div>
			</div>
			<div class="single-popular-places">
				<div class="popular-places-img">
					<img height="400" src="img/places/p2.jpg" alt="">
				</div>
				<div class="popular-places-text">
					<a href="single-blog.html">
					</a>
					<p>Fishers Of Bangladesh</p>
					<h4>
					They live and find the nature.
					</h4>
				</div>
			</div>
			<div class="single-popular-places">
				<div class="popular-places-img">
					<img height="400" src="img/places/p3.jpg" alt="">
				</div>
				<div class="popular-places-text">
					<a href="single-blog.html">
					</a>
					<p>Nilgiri Resort</p>
					<h4>
						The highest altitude hill resort in Banglaesh.
					</h4>
				</div>
			</div>
			<div class="single-popular-places">
				<div class="popular-places-img">
					<img height="400" src="img/places/p4.jpg" alt="">
				</div>
				<div class="popular-places-text">
					<a href="single-blog.html">
					</a>
					<p>Fountains in Bangladesh</p>
					<h4>
					The Depth of Cold Pure Waters.
					</h4>
				</div>
			</div>
		</div>
